...
export default function AuthErrorPage({
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-950 flex items-center justify-center px-4">
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm dark:shadow-xl p-8 w-full max-w-sm text-center">
        <div className="text-3xl mb-4">⚠️</div>
        <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Sign-in failed</h1>
        <p className="text-sm text-gray-500 mb-6">{message}</p>
        <a href="/" className="text-sm text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300">
          ← Back to home
        </a>
      </div>
    </div>
