...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-950 flex items-center justify-center px-4">
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm dark:shadow-xl w-full max-w-sm overflow-hidden">
        ...
        {status === 'sent' ? (
          <div className="p-8 text-center">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              ...
              <br />
              <span className="text-gray-400 dark:text-gray-600">The link expires in 15 minutes.</span>
            </p>
            <button
              onClick={() => { setStatus('idle'); setEmail('') }}
              className="mt-6 text-sm text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 underline underline-offset-2"
            >
            ...
            <div className="p-6">
              <form onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  className="border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2.5 w-full text-sm text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent mb-4"
                />
